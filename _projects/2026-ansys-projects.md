...
<div class="ansys-page">
  <section class="ansys-hero">
    <div class="ansys-shell">
      ...
      <p class="ansys-subtitle">Selected CFD studies highlighting the engineering problem, model setup, governing physics, mesh strategy, convergence, analytical validation, and the most meaningful simulation results.</p>
    </div>
  </section>
    ...
    <div class="ansys-shell">
      ...
      <div class="ansys-calcs">
        ...
        <div class="ansys-calc-grid">
          ...
          <div class="ansys-calc-card">
            <h4>Blasius Thickness &amp; CFD Comparison</h4>
